from train import FaceSynthetics
import sys
import glob
import torch
import os
...
test_dir = './data/TestSample/'
output_dir = './data/TestResult/'
...
model_path = './models/resnet50d.ckpt'
model = FaceSynthetics.load_from_checkpoint(model_path).cuda()
model.eval()

for root_path in [test_dir]:
    ...
    for file_name in img_list:
        ...
        # cv2.imwrite(output_dir+"a_%s"%img_name, aimg)
        ...
        cv2.imwrite(output_dir+"a_%s"%img_name, dimg)
